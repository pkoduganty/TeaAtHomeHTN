...
def test1():
	...
	state.itemstate = {'kettle':{'openstate':teaathome.Itemstate.open, 'fillstate':teaathome.Itemstate.full, 'tempstate':teaathome.Itemstate.hot}, 'coldtap':{'openstate':teaathome.Itemstate.closed}}
